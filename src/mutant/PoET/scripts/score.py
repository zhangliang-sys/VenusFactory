...
import sys
# 添加poet目录到Python路径
poet_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # 获取PoET目录的路径
sys.path.append(poet_dir)
...
def main():
    ...
    # process msa
    msa_filepath = (args.MSA_folder / variants_filename).with_suffix(".a3m")
