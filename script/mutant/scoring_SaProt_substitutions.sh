...
export SaProt_model_path="/home/zliang/project/proteinsquare/checkpoints/SaProt/SaProt_650M_PDB" #Path where you have downloaded all SaProt model/tokenizer files from the HF hub (https://huggingface.co/westlake-repl/SaProt_650M_AF2)
export output_scores_folder="${DMS_output_score_folder_subs}/SaProt/SaProt_650M_PDB"
export foldseek_bin="/home/zliang/software/foldseek/bin/foldseek" #(Download from here: https://github.com/steineggerlab/foldseek?tab=readme-ov-file)
...
do
    ...
    python /home/zliang/project/proteinsquare/ProteinGym/proteingym/baselines/saprot/compute_fitness.py \
    ...
    if [ $? -ne 0 ]; then
        ...
        # 可选：记录失败的索引
        echo ${DMS_index} >> saprot_failed_indices.txt
    fi
