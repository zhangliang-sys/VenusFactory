...
export checkpoint="/home/zliang/project/proteinsquare/checkpoints/Tranception/Tranception_Large"
...
do
    ...
    python /home/zliang/project/proteinsquare/ProteinGym/proteingym/baselines/tranception/score_tranception_proteingym.py \
    ...
    if [ $? -ne 0 ]; then
        ...
        # 可选：记录失败的索引
        echo ${DMS_index} >> tranception_failed_indices.txt
    fi
