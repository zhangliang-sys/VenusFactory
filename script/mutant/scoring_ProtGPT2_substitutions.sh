...
#PBS -N scoring_ProtGPT2_substitutions
...
# 设置模型和输出路径
export ProtGPT2_model_name_or_path="/home/zliang/project/proteinsquare/checkpoints/ProtGPT2"
...
do
    ...
    python /home/zliang/project/proteinsquare/ProteinGym/proteingym/baselines/protgpt2/compute_fitness.py \
    ...
    if [ $? -ne 0 ]; then
        ...
        echo ${DMS_index} >> protgpt2_failed_indices.txt
    fi
