...
export model_name="mif" #[mif|mifst]
export model_path="/home/zliang/project/proteinsquare/checkpoints/MIF"
...
do
    ...
    python  /home/zliang/project/proteinsquare/ProteinGym/proteingym/baselines/carp_mif/compute_fitness.py \
    ...
    if [ $? -ne 0 ]; then
        ...
        # 可选：记录失败的索引
        echo ${DMS_index} >> mif_failed_indices.txt
    fi
