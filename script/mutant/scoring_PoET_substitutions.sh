...
export checkpoint="/home/zliang/project/proteinsquare/checkpoints/PoET/poet.ckpt"
...
do
    ...
    python /home/zliang/project/proteinsquare/ProteinGym/proteingym/baselines/PoET/scripts/score.py \
        --checkpoint ${checkpoint} \
        --DMS_reference_file_path ${DMS_reference_file_path_subs} \
        --DMS_data_folder ${DMS_data_folder_subs} \
        --DMS_index ${DMS_index} \
        --output_scores_folder ${output_scores_folder} \
        --MSA_folder ${DMS_MSA_a3m_data_folder} \
    ...
    if [ $? -ne 0 ]; then
        ...
        # 可选：记录失败的索引
        echo ${DMS_index} >> poet_failed_indices.txt
    fi
